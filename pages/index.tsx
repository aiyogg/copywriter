...
import DropDown, { PlatformType } from "../components/DropDown";
  ...
  return (
    <div className="flex max-w-5xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-12 sm:mt-20">
        ...
        {/* <p className="text-slate-500 mt-5">47,118 topics generated so far.</p> */}
        <div className="max-w-xl w-full">
          ...
          <div className="flex mb-5 items-center space-x-3">
            ...
            <p className="text-left font-medium">选择平台</p>
          </div>
          <div className="block">
            <DropDown platform={platform} setPlatform={(newVibe) => setPlatform(newVibe)} />
          </div>
